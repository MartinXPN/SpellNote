...
public class AdapterDocumentList extends BaseSwipeAdapter {
    ...
    public void fillValues( final int position, final View convertView ) {
        ...
        final ImageView archive = (ImageView) convertView.findViewById( R.id.copy );
        ...
        archive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AdapterDocumentList.this.closeAllItems();
